...
namespace RangarangTestProjectDATA.DataLayer.Services
{
    public class LogRep : ILogRep
    {
        ...
        public LogRep(TheDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<BitResultObject> ExistLogAsync(int LogId)
        {
            BitResultObject result = new BitResultObject();
            try
            {
        ...
        public async Task<ListResultObject<Log>> GetAllLogsAsync(int creatorId = 0, int pageIndex = 1, int pageSize = 20, string searchText = "",string sortQuery ="")
        {
        ...
        public async Task<RowResultObject<Log>> GetLogByIdAsync(int LogId)
        {
        ...
        public async Task<BitResultObject> RemoveLogAsync(int LogId)
        {
            BitResultObject result = new BitResultObject();
            try
            {
