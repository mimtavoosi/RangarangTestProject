...
namespace Services
{
    public class TokenRep : ITokenRep
    {
        ...
        public TokenRep(TheDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<BitResultObject> ExistTokenAsync(int TokenId)
        {
            BitResultObject result = new BitResultObject();
            try
            {
        ...
        public async Task<ListResultObject<Token>> GetAllTokensAsync(int CreatorId = 0, int pageIndex = 1, int pageSize = 20, string searchText = "", string sortQuery = "")
        {
        ...
        public async Task<RowResultObject<Token>> GetTokenByIdAsync(int TokenId)
        {
            RowResultObject<Token> result = new RowResultObject<Token>();
            try
            {
        ...
        public async Task<BitResultObject> MakeTokenExpireAsync(int TokenId)
        {
            BitResultObject result = new BitResultObject();
            try
            {
        ...
        public async Task<BitResultObject> RemoveTokenAsync(int TokenId)
        {
            BitResultObject result = new BitResultObject();
            try
            {
